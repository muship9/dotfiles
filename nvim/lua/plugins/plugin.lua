...
return {
  ...
  keys = {
    -- <leader>fp でプラグインのファイルを検索するキーマップ
    {
      "<leader>fp",
      function()
  ...
  opts = {
    defaults = {
      layout_strategy = "horizontal",  -- レイアウトを水平に
      layout_config = { prompt_position = "top" },  -- プロンプトを上部に
      sorting_strategy = "ascending",  -- 昇順でソート
      winblend = 0,  -- ウィンドウの透過を無効
    },
  },    {
